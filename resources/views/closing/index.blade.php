                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <a href="" class="btn btn-success btn-xs" title="Tambah Data Baru" role="button"
                               data-toggle="modal" data-target="#"><i class="fas fa-plus-circle"></i>Closing</a><br><br>
                                        ...
                                        <form id="tambahtransaksipenjualan" method="post">
                                            ...
                                            <table id="form_penjualan">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="col1">
                                                        <div class="form-group">
                                                            <input type="text" onkeyup="sum();" id="qty_penjualan"
                                                                   name="qty_penjualan" required="required"
                                                                   class="form-control form-control-sm" placeholder="Qty">
                                                        </div>
                                                    </td>
                                                    <td id="col2">
                                                        <div class="form-group">
                                                            <input type="text" onkeyup="sum();" id="harga_barang"
                                                                   name="harga_barang" id="harga_barang" required="required"
