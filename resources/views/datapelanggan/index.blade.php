                                    ...
                                    @foreach ($datapelanggan as $pelanggan)
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach ($dataCuci as $item)
                                                            <tr style="background-color:unset">
                                                                <td
                                                                    style="border:none; {{ $loop->last ? '' : 'border-bottom: 2px solid #dee2e6;' }} border-right: 2px solid #dee2e6">
                                                                    {{ $item->nama_barang }}</td>
                                                                <td
                                            ...
                                            <td>
                                                ...
                                                <a href="/datapelanggan/editpelanggan/{{ $pelanggan->id_pelanggan }}"
                                                   title="Edit" class="btn btn-warning btn-xs" role="button"><i
                                                       class="fas fa-pen"></i></a>

                                                <a href="#" onclick="deletepelanggan({{ $pelanggan->id_pelanggan }})"
                                                   title="Hapus" class="btn btn-danger btn-xs" role="button"><i
                                    ...
                                    <div class="modal-body">
                                        <form id="tambahpelanggan" method="post">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="nama_pelanggan" required="required"
                                                       class="form-control form-control-sm" placeholder="Nama">
                                            </div>

                                            <div class="form-group">
                                                <input type="textarea" name="alamat_pelanggan" required="required"
                                                       class="form-control form-control-sm" placeholder="Alamat">
                                            </div>

                                            <div class="form-group">
                                                <input type="text" name="no_telepon_pelanggan" required="required"
                                                       class="form-control form-control-sm" placeholder="Telepon">
                                            </div>
