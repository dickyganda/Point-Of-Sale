        ...
        <div class="row">
            <div class="col-lg">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <a href="" class="btn btn-success btn-xs" title="Tambah Data Baru" role="button" data-toggle="modal" data-target="#modaltambahdata"><i class="fas fa-plus-circle"></i>
                            Tambah</a><br><br>
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-responsive table-hover table-striped">
                            ...
                            <tbody height="10px">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle; padding:4px 0px">
                                        <table style="width: 100%; height: 100%;">
                                            <tbody>
                                                @foreach ($dt_penjualan as $item)
                                                <tr style="background-color:unset">
                                                    <td style="border:none;  text-align: right ;{{ $loop->last ? '' : 'border-bottom: 2px solid #dee2e6' }}">
                                    ...
                                    <td style="vertical-align:middle; text-align: center">
                                        <a href="/print/printpenjualan/{{ $penjualan->id_penjualan }}" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></a>
                                    </td>
                                    <td>
                                        <table style="width: 100%; height: 100%;">
                                            <tbody>
                                                ...
                                                <tr style="background-color:unset">
                                                    <td style="border:none; {{ $loop->last ? '' : 'border-bottom: 2px solid #dee2e6' }}">
                                                        ...
                                                        <a href="/transaksipenjualan/editpenjualan/{{ $item->id_dt_penjualan }}" title="Edit" class="btn btn-warning btn-xs" role="button"><i class="fas fa-pen"></i></a>

                                                        <a href="#" onclick="deletepenjualan({{ $item->id_dt_penjualan }})" title="Hapus" class="btn btn-danger btn-xs" role="button"><i class="fas fa-trash"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
